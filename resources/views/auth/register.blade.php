        ...
        <div class="w-full bg-white rounded-lg shadow bg-opacity-50 shadow-lg backdrop-blur-md  md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('register') }}" method="POST">
                    ...
                    <div>
                        <label for="tipe_user" class="block mb-2 text-sm font-medium text-black">Status Instansi</label>
                        <select name="user_type" id="user_type" class="bg-gray-50 border border-gray-300 text-black rounded-lg focus:ring-[#c01315] focus:border-[#c01315] block w-full p-2.5">
                            <option value="" disabled selected>Pilih Status Instansi</option>
                            <option value="internal">Internal UNEJ</option>
                            <option value="external">External UNEJ</option>
                        </select>
                    </div>
